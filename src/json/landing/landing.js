const mainPathways = [
        ...
        {
        id: 'business',
        pathwayName: 'Business',
        content: 'Learn the skills required to make an organization successful. Do you want to operate your own business, or want a career that helps manage a company or non-profit organization? Do you like working with numbers and budgets? Want to work in an office environment and assist with administrative tasks? Business is the place for you!',
        programs: [
                    {id: 'acct',
                    name: 'Accounting'
                    },
...
const eduInformation = [
        {
        eduName: 'Highline College',
        mainHeader: 'Academics',
        mainContent: '"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.'
        }
    ];
module.exports = { mainPathways: mainPathways, eduInformation: eduInformation}